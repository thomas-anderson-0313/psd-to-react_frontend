...
class LineChart extends Component {
    ...
    renderPlotBand(band, index) {
        const { from, to } = band;
        const id = `${from}-${to}`;
        const color = (index % 2) ? '#000' : 'rgba(68, 170, 213, 0.1)';
        return (
    ...
    render() {
        ...
        return (
            <div className="app">
                <HighchartsChart plotOptions={plotOptions} color="red">
                    <Chart type="spline" />
          ...
          <Subtitle>May 31 and and June 1, 2015 at two locations in Vik i Sogn, Norway</Subtitle> */}
                    ...
                    <YAxis minorGridLineWidth={0} gridLineWidth={0} alternateGridColor={null}>
                        ...
                        <SplineSeries color="#08D59F" name="Hestavollane" data={[0.2, 0.8, 0.8, 0.8, 1, 1.3, 1.5, 2.9, 1.9, 2.6, 1.6, 3, 4, 3.6, 4.5, 4.2, 4.5, 4.5, 4, 3.1, 2.7, 4, 2.7, 2.3, 2.3, 4.1, 7.7, 7.1, 5.6, 6.1, 5.8, 8.6, 7.2, 9, 10.9, 11.5, 11.6, 11.1, 12, 12.3, 10.7, 9.4, 9.8, 9.6, 9.8, 9.5, 8.5, 7.4, 7.6]} />
